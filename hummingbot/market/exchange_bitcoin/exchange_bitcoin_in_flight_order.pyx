...
from hummingbot.market.exchange_bitcoin.exchange_bitcoin_market import ExchangeBitcoinMarket
from hummingbot.market.in_flight_order_base import InFlightOrderBase


cdef class ExchangeBitcoinInFlightOrder(InFlightOrderBase):
    def __init__(self,
                 client_order_id: str,
    ...
    def from_json(cls, data: Dict[str, Any]) -> InFlightOrderBase:
        ...
        """
        cdef:
            ExchangeBitcoinInFlightOrder retval = ExchangeBitcoinInFlightOrder(
